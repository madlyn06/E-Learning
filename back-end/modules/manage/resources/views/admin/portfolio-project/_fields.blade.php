    ...
    <div class="tab-pane fade show active" id="cmsCategoryInfo">
        <div class="row">
            <div class="col-12 col-md-9">
                @input(['name' => 'name', 'label' => __('manage::portfolio-project.name'), 'required' => true])
                @input(['name' => 'client_name', 'label' => __('manage::portfolio-project.client_name'),])
                @dateinput(['name' => 'year', 'label' => __('manage::portfolio-project.year'),])
                @input(['name' => 'author', 'label' => __('manage::portfolio-project.author'),])
                @input(['name' => 'location', 'label' => __('manage::portfolio-project.location'),])
                @textarea(['name' => 'description', 'label' => __('manage::portfolio-project.description'), 'required' => true])
                @editor(['name' => 'content', 'label' => __('manage::portfolio-project.content'), 'required' => true])
            </div>
            <div class="col-12 col-md-3">
                @translatable

                @checkbox(['name' => 'is_active', 'label' => __('cms::category.is_active'), 'default' => true])
                @select(['name' => 'category_id', 'label' => __('manage::portfolio-project.category_id'), 'options' => get_portfolio_category_parent_options(), 'required' => true])
