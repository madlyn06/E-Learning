...
@section('page_title', __('manage::seo.index.page_title') . ' '. $id)

@section('page_subtitle', __('manage::seo.index.page_subtitle') . ' '. $id)

@section('breadcrumb')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.index') }}">{{ trans('dashboard::message.index.breadcrumb') }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('manage.admin.seo.index') }}">{{ trans('manage::seo.index.breadcrumb') }}</a></li>
            <li class="breadcrumb-item active">{{ trans('manage::seo.edit.breadcrumb') }}</li>
        </ol>
    </nav>
@stop

@php($seo_meta_title = $id.'_seo_meta_title')
@php($seo_meta_description = $id.'_seo_meta_description')
@php($seo_meta_keywords = $id.'_seo_meta_keywords')
@php($seo_meta_og_title = $id.'_seo_meta_og_title')
@php($seo_meta_og_description = $id.'_seo_meta_og_description')
@php($seo_meta_og_image = $id.'_seo_meta_og_image')
@php($seo_meta_twitter_title = $id.'_seo_meta_twitter_title')
@php($seo_meta_twitter_description = $id.'_seo_meta_twitter_description')
@php($seo_meta_twitter_image = $id.'_seo_meta_twitter_image')
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">
                            {{ __('manage::seo.index.page_title') }} {{ $id}}
                        </h6>
                    </div>
