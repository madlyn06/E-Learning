 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Service whereJsonContainsLocale(string $column, string $locale, ?mixed $value)
 * @method static \Illuminate\Database\Eloquent\Builder|Service whereJsonContainsLocales(string $column, array $locales, ?mixed $value)
 * @mixin \Eloquent
 */
class Service extends Model
{
    ...
    protected $table = 'manage__services';
    ...
    {
        return route('manage.web.service.detail', $this->id);
    }
