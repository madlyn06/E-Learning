 ...
 * @property int|null $migrate_category_id
 * @method static \Kalnoy\Nestedset\Collection<int, static> all($columns = ['*'])
 * @method static \Kalnoy\Nestedset\Collection<int, static> get($columns = ['*'])
 * @method static \Kalnoy\Nestedset\QueryBuilder|Category whereIcon($value)
 ...
 * @method static \Kalnoy\Nestedset\QueryBuilder|Category whereMigrateCategoryId($value)
 * @method static \Kalnoy\Nestedset\Collection<int, static> all($columns = ['*'])
 * @method static \Kalnoy\Nestedset\Collection<int, static> get($columns = ['*'])
 * @method static \Kalnoy\Nestedset\Collection<int, static> all($columns = ['*'])
 * @method static \Kalnoy\Nestedset\Collection<int, static> get($columns = ['*'])
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Modules\Manage\Models\File> $files
 * @property-read int|null $files_count
 * @method static \Kalnoy\Nestedset\Collection<int, static> all($columns = ['*'])
 * @method static \Kalnoy\Nestedset\Collection<int, static> get($columns = ['*'])
 * @method static \Kalnoy\Nestedset\QueryBuilder|FileCategory whereCategoryType($value)
 * @property-read mixed $translations
 * @method static \Kalnoy\Nestedset\Collection<int, static> all($columns = ['*'])
 * @method static \Kalnoy\Nestedset\Collection<int, static> get($columns = ['*'])
 * @method static \Kalnoy\Nestedset\QueryBuilder|FileCategory whereJsonContainsLocale(string $column, string $locale, ?mixed $value)
 * @method static \Kalnoy\Nestedset\QueryBuilder|FileCategory whereJsonContainsLocales(string $column, array $locales, ?mixed $value)
 * @method static \Kalnoy\Nestedset\Collection<int, static> all($columns = ['*'])
 * @method static \Kalnoy\Nestedset\Collection<int, static> get($columns = ['*'])
 * @mixin \Eloquent
 */
class FileCategory extends Model
{
    ...
    protected $table = 'manage__file_categories';
    ...
    {
        return route('manage.web.file-category.detail', $this->id);
    }

    public function files()
    {
        return $this->belongsToMany(File::class, 'manage__file_file_category');
    }
