 ...
 * @method static \Illuminate\Database\Eloquent\Builder|PortfolioCategory whereJsonContainsLocale(string $column, string $locale, ?mixed $value)
 * @method static \Illuminate\Database\Eloquent\Builder|PortfolioCategory whereJsonContainsLocales(string $column, array $locales, ?mixed $value)
 * @mixin \Eloquent
 */
class PortfolioCategory extends Model
{
    ...
    protected $table = 'manage__portfolio_categories';
    ...
    {
        return route('manage.web.portfolio-categories.detail', $this->id);
    }
