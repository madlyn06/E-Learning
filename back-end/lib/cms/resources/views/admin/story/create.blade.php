...
@section('meta_title', __('cms::story.create.page_title'))

@section('page_title', __('cms::story.create.page_title'))

@section('page_subtitle', __('cms::story.create.page_subtitle'))
...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ trans('cms::story.create.breadcrumb') }}</li>
        </ol>
    </nav>
@stop

@section('content')
    <form action="{{ route('cms.admin.stories.store') }}" method="POST">
        @csrf
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">
                            {{ __('cms::story.create.page_title') }}
                        </h6>
                    </div>
