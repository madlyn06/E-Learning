...
<table class="table table-hover">
    <thead>
        <tr>
            <th>
                <input type="checkbox" id="group" name="group2" onclick="checkMediaItem('group', 'itemImage');" />
            </th>
            <th>Thumbnail</th>
            <th>Name</th>
            <th class="text-center">
                <a href="#" data-toggle="modal" data-target="#deleteImage" class="btn btn-danger">
                    Delete
                </a>
            </th>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <table-button-delete url-delete="{{ route('media.admin.media.destroy', $media->id) }}"></table-button-delete>
            </td>
        </tr>
        @endforeach
    </tbody>
