    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h3>File manager</h3>
                <p id="notification-progress" style="display: none;color:red"><strong>File đang được upload, vui lòng đợi ...</strong></p>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#image-upload-{{$name}}').change(function () {
                ...
                $('#notification-progress').css('display', 'block')
                $.ajax({
                    ...
                    contentType: false,
                    success: function (res) {
                        $('#notification-progress').css('display', 'none')
                        if (res.status == 400) {
                            alert(res.message)
                            return
                        }
            ...
            $('#liveToastBtn').click(function() {
                ...
                toastList.forEach(toast => toast.show()); // This will show the toast
            })
        })
    </script>
@endpush
