    ...
    <div class="modal-content-ads">
        ...
        <p>
            <input placeholder="Nhập mã vào đây..." id="ads_code" style="
                ...
                border-radius: 5px" value="{{ $adsItem?->title }}" size="20">
        ...
        <p>Bước 4: Nhập mã vào ô bên dưới và <strong>Xác Nhận</strong> </p>
    </div>
</div>
<form method="post" id="form-input-code" style="margin-top: 10px; border: 1px solid #fa7e5f;padding: 20px;border-radius: 5px; text-align: center;">
    <div class="popup-ads">
      ...
      <div style="display:flex;justify-content: center">
        <input placeholder="Nhập mã vào đây..." name="post_password" id="code_content" style="
            ...
            border: 0.01px solid #b4b4b4;
            border-radius: 5px;
            margin-right: 10px" type="text" size="20">
...
<input type="hidden" id="hashed" value="{{ $ads->hashed }}"/>
