 ...
 * @method static \Illuminate\Database\Eloquent\Builder|InternalLink whereIsActive($value)
 * @method static \Illuminate\Database\Eloquent\Builder|InternalLink whereLocale(string $column, string $locale)
 * @method static \Illuminate\Database\Eloquent\Builder|InternalLink whereLocales(string $column, array $locales)
 * @method static \Illuminate\Database\Eloquent\Builder|InternalLink whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|InternalLink whereValue($value)
 * @mixin \Eloquent
 */
class InternalLink extends Model
{
    ...
    protected $table = 'seo__internal_links';
