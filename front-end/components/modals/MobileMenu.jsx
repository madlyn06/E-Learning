      ...
      >
        ...
        <div className='offcanvas-body'>
          <ul className='list-group'>
            {[{ title: 'Categories', subItems: categories, noActive: true }, ...menuItems].map((item, index) => (
              <li className={`list-group-item ${item.noActive ? 'disabled-active-menu' : ''}`} key={index}>
                {item.subItems ? (
                  <>
                    <a
                      href='#!'
                        ...
                        <li className='list-group-item' key={subIndex}>
                          {subItem.subItems ? (
                            <>
                              ...
                              <ul id={`submenu${index}-${subIndex}`} className='list-group collapse'>
                                {subItem.subItems.map((subSubItem, subSubIndex) => (
                                  <li className='list-group-item' key={subSubIndex}>
                                    <Link
                  ...
                  <Link className={`nav-link-mobile   ${isMenuActive(item) ? 'activeMenu' : ''}`} href={item.href}>
                    {item.title}
                  </Link>
                )}
              </li>
