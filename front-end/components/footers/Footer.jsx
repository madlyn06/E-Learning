...
export default function Footer({ parentClass = 'footer' }) {
  ...
  const menuItems = appData?.footer?.items || []
                ...
                <div className="footer-body-wrap flex justify-between">
                  <div className="footer-more-infor wow fadeInUp" data-wow-delay="0s">
                    <div className="footer-logo">
                      <Link href={`/`}>
                        <img src="/images/logo/logo.svg" alt="Logo" width={123} height={36} />
                      </Link>
                    </div>
                  ...
                  {menuItems.map((menu, index) => (
                    <div key={index} className="footer-menu-list wow fadeInUp" data-wow-delay={menu.delay}>
                      <h5 className="fw-5">{menu.label}</h5>
                      <ul>
            ...
            <div className="row">
              <div className="col-12">
                <div className="footer-bottom-wrap flex justify-center items-center">
                  <p>©&nbsp;{new Date().getFullYear()}&nbsp;sgkphattriennangluc.vn. All Rights Reserved</p>
                </div>
              </div>
            </div>
          </div>
