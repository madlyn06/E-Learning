        ...
        <div className="row justify-center">
          <div className="col-xl-10 col-sm-12">
            <div className="heading-section text-center">
              <h2 className="fw-7 font-cardo wow fadeInUp" data-wow-delay="0.2s">
                Purchases & Refunds
              </h2>
            ...
            <div className="tf-accordion-default tf-accordion w-800" id="accordionExample">
              <Accordions childrenHeader={"High-Quality Video Lessons"} />
            </div>
          </div>
        </div>
      </div>
